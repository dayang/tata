...
fn rocket() -> Rocket {
    rocket::ignite()
        ...
        .mount("/", routes![controllers::post::index, controllers::about, controllers::favicon])
        ...
        .attach(Template::custom(|engines| {
            ...
            engines.handlebars.register_helper("not_empty_str", Box::new(crate::helpers::NotEmptyStrHelper));
        }))
}
